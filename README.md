...
[![Build Status](https://github.com/stephenzl/ripple/actions/workflows/go.yml/badge.svg)](https://github.com/stephenzl/ripple/actions/workflows/go.yml)
...
Please bear in mind that this has been an exercise that has taken a lot of time, so if you want to help and are not a developer, bounties and thanks are more than welcome. Please see the [AUTHORS](https://github.com/stephenzl/ripple/blob/master/AUTHORS) file. If you'd like to chat about the code, have a look here:
